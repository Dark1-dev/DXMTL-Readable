//=============================================================================
// MTLMenuScreenJoinLan. Rebuild with ScriptRays.
//=============================================================================
...
function bool ButtonActivated( Window buttonPressed )
{
	...
	// 0x0002:     EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.bHandled)
	// 0x0007:   EX_True
	// 0x0008: EX_Switch (MemSize=4)
	// 0x000A:   EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.buttonPressed)
	...
	// 0x001E:   EX_ObjectConst (ObjectConst=Class DXMTL152b1.MTLMenuScreenHostLan)
	// 0x0024: EX_Jump (JumpOffset=0x0035)
	// 0x0027: EX_Case (NextOffset=0xFFFF)
	// 0x002A: EX_LetBool
	// 0x002B:   EX_BoolVariable
	// 0x002C:     EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.bHandled)
	// 0x0031:   EX_False
	...
	// 0x003A:       EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.bHandled)
	// 0x0040: EX_LetBool
	// 0x0041:   EX_BoolVariable
	// 0x0042:     EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.bHandled)
	// 0x0047:   EX_FinalFunction (Function=DXMTL152b1.MTLMenuScreenJoinGame.ButtonActivated,OperatorType=0)
	// 0x004C:     EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.buttonPressed)
	// 0x0052: EX_Return
	// 0x0053:   EX_BoolVariable
	// 0x0054:     EX_LocalVariable (Property=DXMTL152b1.MTLMenuScreenJoinLan.ButtonActivated.bHandled)
	// 0x0059: EX_Return
	// 0x005A:   EX_Nothing
	//
